<%--
	...
	2. include 지시어 : 다른 Jsp를 포함, 굳이 똑같은 정보를 매번 작성 하는거보다 고정값을 정해두는게 효율적일때
...
<body>
	...
	<%-- JSP 주석 : HTML 주석과 달리 "페이지 소스 보기"에서 보이지 않는다, 자바 코드는 안보인다. --%>
	...
	<%-- 연습1. getNumber() 메소드의 반환 결과가 5이상이면 "큰수", 아니면 "작은 수"를 출력하시오. --%>
